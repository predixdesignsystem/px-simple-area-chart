...
function runBaseTests() {
  px_simple_area_chart_1 = document.getElementById('px_simple_area_chart_1');

  suite('Base Automation Tests for px-simple-area-chart', function() {
